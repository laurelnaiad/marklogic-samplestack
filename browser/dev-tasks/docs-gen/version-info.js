  ...
  return _(previousVersions)
    ...
    .reduce(function(cdnVersion, version) {
      if (!cdnVersion) {
        ...
        var cdnResult = shell.exec('curl http://ajax.googleapis.com/ajax/libs/angularjs/'+ hardVersion +'/angular.min.js '+
...
var getSnapshotVersion = function() {
  ...
  if ( !version ) {
    ...
    // SCS
    version = semver(currentPackage.branchVersion.replace('*','0-ea2'));
  }
...
exports.cdnVersion = cdnVersion = '1.3.0-rc.0'; // getCdnVersion();
