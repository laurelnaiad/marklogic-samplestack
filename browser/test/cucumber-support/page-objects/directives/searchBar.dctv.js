...
module.exports.support = function (obj) {
  ...
  obj.clearSearchTextWithBtn = function () {
    return obj.pself(getSearchbarClearElement()
      .click()
    );
  };
  ...
  var getSearchbarClearElement = function () {
    return element(by.css('.search-clear .glyphicon-remove'));
  };
