...
define([
  '_marklogic/module',
  'json!schema/_marklogic/search.json',
  'json!schema/_marklogic/searchConstraintBase.json',
  'json!schema/_marklogic/searchConstraintBoolean.json',
  'json!schema/_marklogic/searchConstraintDateTime.json',
  'json!schema/_marklogic/searchConstraintEnum.json',
  'json!schema/_marklogic/searchConstraintText.json',
  'json!schema/_marklogic/searchCriteria.json',
  'json!schema/_marklogic/searchResults.json'
], function (
  module,
  schemaSearch,
