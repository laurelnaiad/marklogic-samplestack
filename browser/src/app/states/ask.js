...
define(['app/module'], function (module) {
  ...
  module.controller('askCtlr', [
    ...
    function ($scope, appRouting, ssQnaDoc, ssTagsSearch) {
      ...
      /**
       * @ngdoc method
       * @name askCtlr#$scope.loadTags
       * @description Posts the new tag search to the server and generates a
       * tags array that is returned for rendering in the UI.
       */
      ...
      /**
       * @ngdoc method
       * @name askCtlr#$scope.tagSelected
       * @description Determine if the tag has been selected already.
       */
      ...
      /**
       * @ngdoc method
       * @name askCtlr#$scope.parseTag
       * @description Remove trailing freq in parens.
       */
