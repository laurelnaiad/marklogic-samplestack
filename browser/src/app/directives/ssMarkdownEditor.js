...
define([
   ...
   * |--|--|--|
   * | `selTab`  | {@type string}  | Used by the form group to show/hide the editor vs the preview pane. |
   * | `placeholder` | {@type string} | Placeholder text for the markdown input box. |
   */
