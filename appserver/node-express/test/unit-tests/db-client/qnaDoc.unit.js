...
module.exports = function () {
  ...
  describe('qnaDoc',function () {
    ...
    it('post', function (done) {
      ...
      var contributor;
      var spec;
      var docsPostWriteReq;
      var docsPostWriteResp;
      var ret;
      /* jshint ignore:start */
      now = moment();
      txid = null;
      contributor = {id:'cf99542d-f024-4478-a6dc-7e723a51b040',displayName:'JoeUser'};
      spec = { title: 'test', text: 'test', tags: [ '.htaccess' ] };
      docsPostWriteReq = {txid:null,uri:'/questions/99753e7e-fbeb-435b-af58-2f4630181f0f.json',contentType:'applicaton/json',content:{accepted:false,acceptedAnswerId:null,comments:[],answers:[],answerCount:0,itemTally:0,upvotingContributorIds:[],downvotingContributorIds:[],voteCount:0,title:'test',text:'test',tags:['.htaccess'],lastActivityDate:now,creationDate:now,id:'99753e7e-fbeb-435b-af58-2f4630181f0f',owner:{id:'cf99542d-f024-4478-a6dc-7e723a51b040',displayName:'JoeUser'}}};
      docsPostWriteResp = {documents:[{uri:'/questions/99753e7e-fbeb-435b-af58-2f4630181f0f.json',categories:undefined,contentType:null}]};
      ret = { id: '99753e7e-fbeb-435b-af58-2f4630181f0f' };
      /* jshint ignore:end */
    ...
    it('patch - acceptAnswer', function (done) {
      ...
      docsPatch = {txid: txid,uri:'/questions/8450f8a4-2782-4c8a-9fd9-b83bcacc5019.json'};
      docsPatchResult = { uri: '/questions/8450f8a4-2782-4c8a-9fd9-b83bcacc5019.json' };
      ret = { id: '8450f8a4-2782-4c8a-9fd9-b83bcacc5019' }
      /* jshint ignore:end */
